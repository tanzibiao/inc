...
public class FilterContextHandler {
    ...
    public static Integer getUserID4Int() {
    ...
    public static String getReqURL() {
        Object value = get(CommonConstants.REQ_URL);
        return returnObjectValue(value);
    }
    ...
    public static void setReqURL(String ip) {
        set(CommonConstants.REQ_URL, ip);
    }
